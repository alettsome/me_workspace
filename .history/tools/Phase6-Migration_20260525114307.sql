...
-- SQLite doesn't support adding columns with foreign keys, so we'll add them without constraints
ALTER TABLE "Sources" ADD COLUMN "ProjectId" TEXT NULL;
ALTER TABLE "Sources" ADD COLUMN "Author" TEXT NULL;
ALTER TABLE "Sources" ADD COLUMN "ISBN" TEXT NULL;
ALTER TABLE "Sources" ADD COLUMN "URL" TEXT NULL;
ALTER TABLE "Sources" ADD COLUMN "Publisher" TEXT NULL;
ALTER TABLE "Sources" ADD COLUMN "PublicationYear" INTEGER NULL;
ALTER TABLE "Sources" ADD COLUMN "BorrowingSource" TEXT NULL;
ALTER TABLE "Sources" ADD COLUMN "AccessExpiryUtc" TEXT NULL;

-- Create indexes on new Source columns
CREATE INDEX IF NOT EXISTS "IX_Sources_Status" ON "Sources" ("Status");
CREATE INDEX IF NOT EXISTS "IX_Sources_AccessExpiryUtc" ON "Sources" ("AccessExpiryUtc");
