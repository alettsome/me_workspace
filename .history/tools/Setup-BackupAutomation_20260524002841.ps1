...
if (-not (Test-Path $BackupRoot)) {
    ...
    Write-Host "[OK] Created: $BackupRoot" -ForegroundColor Green
}
else {
    Write-Host "[OK] Already exists: $BackupRoot" -ForegroundColor Green
}
Write-Host ""
...
try {
    ...
    Write-Host "[OK] Restore script validated" -ForegroundColor Green
...
Write-Host ""
Write-Host "[SUCCESS] Backup system is ready!" -ForegroundColor Green
Write-Host ""
